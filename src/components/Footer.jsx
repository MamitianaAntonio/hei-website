        ...
        <>
            <div className="flex justify-center bg-blue-950 text-white gap-25 p-7">
                <div className="max-w-50">
                    <img className="h-17 mb-5" src="https://www.hei.school/wp-content/uploads/2022/09/Logo-e1662790239183.png" alt="" />
                ...
                <div className="max-w-50 flex flex-col gap-1 ">
                    <h3 className="mt-22 font-semibold">Adresse</h3>
                    <p>II J 161 R Ambodivoanjo</p>
                    <p>Ivandry Antananarivo</p>
                    <p>101, Madagascar</p>
                </div>
                <div className="max-w-50 flex flex-col gap-1">
                    <h3 className="mt-22 font-semibold">Navigation</h3>
            ...
            <div>
                <p className="text-gray-400 text-center font-semibold">© HEI Madagascar</p>
            </div>
        </>
    );
}
