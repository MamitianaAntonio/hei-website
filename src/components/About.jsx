  ...
  return (
    <div className="flex p-5 m-10 items-center justify-center gap-10">
      ...
      <div className="flex flex-col gap-10 w-1/3">
        <h1 className="text-5xl font-bold text-gray-800">A propos de nous</h1>

        <div className="flex flex-col gap-10">
          <div className="flex items-center gap-3">
            <FontAwesomeIcon icon={faGraduationCap} size="3x" />
            <h3 className="text-xl font-bold">+3ans</h3>
          </div>

          <p className="w-4xs text-md leading-7">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-bold">+250 étudiants</h3>
          </div>

          <p className="w-4xs leading-7 text-md">
